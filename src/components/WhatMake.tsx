...
const WhatMake = () => {
  return (
    <section
      id="usecase"
      className="px-6 md:px-[100px] py-20 2xl:py-44 text-white bg-gradient-to-br from-[#5B1D91] via-[#2A0E56] to-[#0D0B3C] text-center"
    >
      {/* Header */}
      ...
      <h3 className="text-[#FE5868] text-3xl  md:text-2xl 2xl:text-4xl font-bold md:mb-12">
        ...
        <div className="relative hidden md:block">
          ...
          <div className="absolute  w-full flex  items-center   top-1/3  transform  space-x-4  -translate-y-1/3">
           ...
           <img src={brain} alt="robot" className="w-16 h-16 mt-[40px] text-purple-300 mx-auto"  />
            ...
            <div className="w-1/8">
              ...
              <img src={navigation} alt="robot" className="w-16 h-16 mt-[20px] text-purple-300 mx-auto"  />
            
    
            </div>
            <div className="w-1/8">
             <img src={auto} alt="robot" className="w-16 h-16 mt-[40px] text-purple-300 mx-auto"  />
            ...
            <div className="w-1/8">
             <p className="font-medium mt-[-50px] text-xl  2xl:text-2xl">Language</p>
              <img src={language} alt="robot" className="w-16 h-16  text-purple-300 mx-auto mt-[20px]"  />
             
 
            </div>
            <div className="w-1/8">
              <img src={interaction} alt="robot" className="w-16 h-16  text-purple-300 mx-auto mt-[40px]"  />
            ...
            <div className="w-1/8">
              ...
              <img src={growth} alt="robot" className="w-16 h-16  text-purple-300 mx-auto mt-[20px]"  />
            
   
            </div>
            <div className="w-1/8 ">
              <img src={network} alt="robot" className="w-16 h-16  text-purple-300 mx-auto mt-[40px] "  />
      ...
      {/* Our Mission */}
      <h3 className="text-2xl md:text-3xl xl:text-4xl 2xl:text-6xl font-bold mb-6 mt-10">Our Mission</h3>
