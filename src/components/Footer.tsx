...
const Footer = () => {
  return (
    <footer className="w-full text-white relative overflow-hidden py-20 px-6 sm:px-10 md:px-14 lg:px-[80px] xl:px-[112px]">
      ...
      <div className="relative flex flex-col md:flex-row  justify-between items-center max-w-6xl 2xl:max-w-7xl mx-auto text-sm text-white/70 gap-4 z-10 text-center md:text-left">
